...
document.getElementById('foodForm').addEventListener('submit', async function (e) {
    ...
    console.log('Datos del formulario comida:', formData);
    ...
    try {
        ...
        console.log('Respuesta registro comida:', result);
        ...
        if (result.success) {
            ...
            console.log('Llamando a updateUserPoints con:', { puntos: 50, tipo: 'comida' });
        ...
        CustomAlert.show('Error al registrar la comida: ' + error.message, 'error');
    }
});

// Form submission - Alimento personalizado
